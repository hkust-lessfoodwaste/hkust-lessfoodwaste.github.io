...
const fetchData = async () => {
  ...
  let summaryRes = await axiosRequest("get", "summary", {}, true);
  isLoading.value = false;
  if (summaryRes.error === false) {
    let summaryData = summaryRes.result;
    overviewAvgData.value = summaryData.overview.curr_average;
    overviewRelativeData.value = summaryData.overview.relative_average;
